# This Makefile is for the Mojolicious::Plugin::KossyValidator extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Mojolicious-Plugin-KossyValidator]
#     EXE_FILES => []
#     LICENSE => q[perl]
#     NAME => q[Mojolicious::Plugin::KossyValidator]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Mojolicious=>q[3.0] }
#     clean => { FILES=>q[Dancer-Plugin-KossyValidator-*] }
...
NAME_SYM = Mojolicious_Plugin_KossyValidator
VERSION = 
...
MAKE = make
FULLEXT = Mojolicious/Plugin/KossyValidator
BASEEXT = KossyValidator
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Mojolicious/Plugin/KossyValidator.pm
...
TO_INST_PM = lib/Mojolicious/Plugin/KossyValidator.pm

PM_TO_BLIB = lib/Mojolicious/Plugin/KossyValidator.pm \
...
DISTVNAME = Mojolicious-Plugin-KossyValidator-
...
manifypods : pure_all  \
	lib/Mojolicious/Plugin/KossyValidator.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Mojolicious/Plugin/KossyValidator.pm $(INST_MAN3DIR)/Mojolicious::Plugin::KossyValidator.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  $(BASEEXT).exp 
	- $(RM_RF) \
	  Dancer-Plugin-KossyValidator-* blib 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Mojolicious-Plugin-KossyValidator' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Mojolicious: 3.0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Mojolicious-Plugin-KossyValidator",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Mojolicious" : "3.0",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Mojolicious::" VERSION="3" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Mojolicious/Plugin/KossyValidator.pm blib/lib/Mojolicious/Plugin/KossyValidator.pm 
